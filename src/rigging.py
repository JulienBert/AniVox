...
class Bone():
    def __init__(self, name, adp0, adp1, tColor):
        ...
        #                                  0      1      2     3      4
        self.mRestPoseVertex = np.matrix([[p0[0], p1[0], p[0], pp[0], pm[0]],
                                          [p0[1], p1[1], p[1], pp[1], pm[1]],  
                                          [p0[2], p1[2], p[2], pp[2], pm[2]],
                                          [    1,     1,    1,     1,     1]], 'float32')

        self.aDrawEdges = np.array([[0, 3], [0, 4], [3, 4], [4, 1], [3, 1]], 'int16')
